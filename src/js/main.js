...
class Potatmon {
    ...
    attackPotatmon(potatmon) {
        potatmon.hp -= this.attack / potatmon.defense;
        document.getElementById("enemyHealth").innerText = potatmon.hp;
        if (potatmon.hp < 0) {
            potatmon.hp = 0;
        }
...
function reloadActivePotatmonInfo() {
    // our potatmon
    document.getElementById("playerHealth").innerText = player.activePotatmon.hp;
    document.getElementById("playerActivePotatmon").innerText = player.activePotatmon.name;
    // enemy potatmon
    document.getElementById("enemyHealth").innerText = enemy.activePotatmon.hp;
...
let bench = [watermander, grasle, arsosaur];
